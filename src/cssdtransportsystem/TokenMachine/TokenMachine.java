 ...
 * @author Shakuni
 */
public class TokenMachine extends javax.swing.JFrame {

    /**
     * Creates new form TokenMachine
     */
    public TokenMachine() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        javax.swing.GroupLayout TokenMachineUILayout = new javax.swing.GroupLayout(TokenMachineUI);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TokenMachine.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TokenMachine().setVisible(true);
            }
        });
    }
